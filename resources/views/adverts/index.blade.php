...
@section('content')
    ...
    <div class="row">
                    ...
                    <div class="advert">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div>
                                    {{ \Illuminate\Support\Str::limit($advert->content, 200) }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-3">
            <div style="height: 400px; background: lightgray; border: 1px solid #ddd; margin-bottom: 20px"></div>
            <div style="height: 200px; background: lightgray; border: 1px solid #ddd; margin-bottom: 20px"></div>
{{--            <div--}}
{{--                class="banner mb-3"--}}
